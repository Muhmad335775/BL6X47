...
class CinematicRecordingActivity : Activity() {
    ...
    // Safety timeout: if rendering hasn't finished within this window,
    // stop silently hanging and show a clear error instead.
    private val maxRenderTimeMs = 60_000L
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Watchdog: if the pipeline hangs, surface an error instead of a
        // silent black screen forever.
