...
class RecorderButtonView @JvmOverloads constructor(
    ...
    // Plays on the MEDIA stream (like music/YouTube), not the system/ringer stream —
    // this keeps working even when the phone's ringer switch is on silent.
    ...
    // Generates an audible "tick" tone on the MEDIA stream — bypasses the ringer/silent switch.
