...
class RecorderButtonView @JvmOverloads constructor(
    ...
    interface Listener {
        fun onPressStart()
        /** progress 0f (no drag) .. 1f (fully at cancel threshold) */
    ...
    // Full cancel now triggers at a shorter, easier drag distance (was 100dp)
    ...
    override fun onTouchEvent(event: MotionEvent): Boolean {
        when (event.actionMasked) {
            ...
            MotionEvent.ACTION_MOVE -> {
                ...
                // Visual feedback: button + hint follow the finger as it drags left
    ...
    private fun endPress() {
        ...
        // Snap back to original position, and clear the hint fade
    ...
    private fun vibrateCancelConfirm() {
        vibrateOneShot(40)
    }
