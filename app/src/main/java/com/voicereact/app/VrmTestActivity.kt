...
class VrmTestActivity : Activity() {
    ...
    // CRITICAL: without any light in the scene, a PBR-shaded VRM model
    // renders pure black even though it loaded correctly. This was missing.
    private fun addSceneLighting() {
        ...
        try {
            ...
            // Soft fill light from the front so the model isn't half-black
